...
GROQ_API_KEY = os.environ.get("GROQ_API_KEY", "paste-your-groq-key-here")
...
def build_pipeline():
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system", "You are an HR assistant for Zyro Dynamics. Answer using ONLY the HR policy documents below. Be specific with numbers and details. If not found, say you don't have that information.\n\nContext: {context}"),
        ("human", "{question}")
    ])
